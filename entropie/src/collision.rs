...
pub struct CollisionInfo {
    ...
    ///
    /// This vector is always equal to the difference between the contact points on the two objects, i.e. `contact_point_2 - contact_point_1`.
    pub separation_vector: Vec3,

    /// A point on the surface of the first object that is in contact with the second object.
    ///
    /// If one applies the `separation_vector` to the second object, the two objects will be exactly touching at this point.
