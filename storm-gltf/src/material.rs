...
pub(super) struct Material {
    ...
    #[serde(skip)]
    loaded: Option<tempete::mesh::material::Material>,
...
impl Material {
    pub(super) fn load(
    ...
    ) -> anyhow::Result<tempete::mesh::material::Material> {
        ...
        let mut builder = tempete::mesh::material::MaterialBuilder::default()
            .base_color_factor(pbr.base_color_factor)
            .metallic_factor(pbr.metallic_factor)
            .roughness_factor(pbr.roughness_factor)
            .emissive_factor(self.emissive_factor)
            .alpha_mode(match self.alpha_mode {
                AlphaMode::Opaque => tempete::mesh::material::AlphaMode::Opaque,
                AlphaMode::Mask => tempete::mesh::material::AlphaMode::Mask,
                AlphaMode::Blend => tempete::mesh::material::AlphaMode::Blend,
            })
