use crate::{
    Environment, Id,
    environment::{EnvironmentBuilder, EnvironmentBuilderData},
    geometry::{Geometry, GeometryBuilder, GeometryBuilderData},
    mesh::{Material, MaterialBuilder, Mesh, MeshBuilder, MeshBuilderData},
    storage::SparseSet,
    texture::{TextureBuilder, TextureBuilderData},
};
...
impl<Storm: crate::Storm> crate::Resources<Storm> for Resources {
