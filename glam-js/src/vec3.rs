...
impl Vec3 {
    ...
    /// # Panics
    /// Panics if slice is less than 3 elements long.
    pub fn writetoSlice(self, slice: &mut [f32]) {
    ...
    pub fn dotIntoVec(self, rhs: Self) -> Self {
    ...
    pub fn minPosition(self) -> usize {
        self.0.min_position()
    }

    /// Returns the index of the first maximum element of `this`.
    pub fn maxPosition(self) -> usize {
        self.0.max_position()
    }
    ...
    ///
    /// In other words, this computes `this.x * this.y * ..`.
    pub fn elementProduct(self) -> f32 {
    ...
    pub fn isNegativeBitmask(self) -> u32 {
    ...
    pub fn tryNormalize(self) -> Option<Self> {
    ...
    pub fn projectOnto(self, rhs: Self) -> Self {
    ...
    pub fn rejectFrom(self, rhs: Self) -> Self {
    ...
    pub fn projectOntoNormalized(self, rhs: Self) -> Self {
    ...
    ///
    /// `rhs` must be normalized.
    pub fn rejectFromNormalized(self, rhs: Self) -> Self {
    ...
    pub fn moveTowards(&self, rhs: Self, d: f32) -> Self {
    ...
    pub fn absDiffEq(self, rhs: Self, max_abs_diff: f32) -> bool {
        self.0.abs_diff_eq(rhs.0, max_abs_diff)
    }

    /// Returns a vector with a length no less than `min` and no more than `max`.
    pub fn clampLength(self, min: f32, max: f32) -> Self {
        Self(self.0.clamp_length(min, max))
    }

    /// Returns a vector with a length no more than `max`.
    pub fn clampLengthMax(self, max: f32) -> Self {
        Self(self.0.clamp_length_max(max))
    }

    /// Returns a vector with a length no less than `min`.
    pub fn clampLengthMin(self, min: f32) -> Self {
    ...
    /// in mind.
    pub fn mulAdd(self, a: Self, b: Self) -> Self {
